...
export default function Error404() {
  return (
    <>
      ...
      <div class="px-4 py-8 mx-auto bg-slate-50 text-slate-950 dark:bg-slate-900 dark:text-slate-200 min-h-screen justify-center items-center flex">
        <h1 class="font-bold tracking-normal text-2xl">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 125 149.83"
            class="w-16 h-16 inline-block pr-3 align-middle"
          >
            <defs>
